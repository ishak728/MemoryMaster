...
class LevelTwoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prologue0=Music(this@LevelTwoActivity)
        victory1=Music(this@LevelTwoActivity)
        shocked2=Music(this@LevelTwoActivity)
        congratulations3=Music(this@LevelTwoActivity)
        prologue0.start()
        victory1.start()
        shocked2.start()
    ...
    fun startTime(time:Long){
        ...
        object : CountDownTimer(time,1000){
            ...
            override fun onFinish() {
                ...
                if (!(this@LevelTwoActivity).isFinishing) {
                    ...
                    builder.setPositiveButton("YES") { dialog, which ->
                        ...
                        val intent = Intent(this@LevelTwoActivity, LevelTwoActivity::class.java)
                    ...
                    builder.setNegativeButton("NO") { dialog, which ->
                        ...
                        val intent =
                            Intent(this@LevelTwoActivity, SelectionLevelActivity::class.java)
                        startActivity(intent)
                        finish()
                    }
